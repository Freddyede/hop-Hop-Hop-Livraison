 ...
 */
final class Version20200517110202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD user_id_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD username LONGTEXT NOT NULL');
    }
